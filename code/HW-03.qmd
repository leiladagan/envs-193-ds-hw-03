...
For my personal data, I wanted to track how long my showers are on work days compared to non work days. In order to bring my project back to the environmental impacts, I think it would be interesting to make a plot with my minutes showered lined up, (perhaps a histogram), and connect the dots to make a body of water. I think it would be interesting to have a shower head filling up the water. 
...
```{r}
knitr::include_graphics("curved_carapace_clutch_size.png")
```
